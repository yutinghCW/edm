...
function makeSourceCode(key, worksheet) {
	...
	$.getJSON(gspreadsheets, function(result){
		...
		// 組裝原始碼第一段，版頭及表頭
		previewHead = '<div style="display:none; font-size:1px; line-height:1px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; mso-hide:all; font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif;">我是一個大家看不到的前言</div><table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" width="600" class="email-container"><tr><td style="padding: 20px 6.6675%; line-height: 0; text-align: center;"><a href="http://opinion.cw.com.tw/" target="_blank" rel="noopener noreferrer"><img src="https://topic.cw.com.tw/salesforce/assets/images/opinion-logo-vertical@3x.png" height="55" alt="獨立評論@天下 Logo" border="0"></a></td></tr><tr><td style="text-align: center"><h2 style="margin: 0 0 5px; padding: 0 6.6675%; color: #313160; font-family: \'Noto Serif TC\', \'思源宋體 TC\', \'思源宋體 TW\', \'思源宋體\', serif; font-size: 1.75rem;">' + data.funcColum[0].columTitle + '</h2><time style="margin-bottom: 10px; padding: 0 6.6675%; color: #777; font-size: 0.875rem;">2020-11-03</time><div style="margin: 10px 0 20px; padding: 0 6.6675%; color: #000; font-size: 1rem; font-weight: 300; line-height: 1.7; text-align: left; white-space: pre-line;">' + data.funcColum[0].columText + '</div>';
		
		if ( data.funcColum[0].columButton !== "" ) {
			previewHead += '<table cellspacing="0" cellpadding="0" border="0" align="center"><tr><td style="text-align: center;"><a href="#!" style="display: block; padding: 0 1em; color: #ffffff; font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif; font-size: 0.875rem; text-decoration: none; background: #313160; border: 0.5em solid #313160; border-radius: 5px;" class="button-a"><!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]-->' + data.funcColum[0].columButton + '<!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]--></a></td></tr></table>';
		}
		...
		$(function() {
			$.each(data.funcColum, function(i, f) {
				...
				switch (f.columType) {
					case 'Block-Start':
						codeBody += '<div style="padding: 20px 0;"></div><table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" width="600" class="email-container">';
					...
					case 'Single-Article':
						...
						if ( f.columText !== "" ) {
							...
							codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; font-weight: 300; line-height: 1.25; white-space: pre-line;">' + TextEllipsis_55_1 + '</div>';
						}
						codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1;"><a href="' + f.columChannelLink + '" target="_blank" rel="noopener noreferrer" style="margin-right: 10px; color: #313160; font-weight: 500; text-decoration: none;">' + f.columChannel + '</a><span style="font-weight: 300;">作者 ' + f.columAuthor + '</span></div>';
						if ( f.columButton !== "" ) {
					...
					case 'Text-Button':
						...
						if ( f.columText !== "" ) {
							...
							codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; font-weight: 300; line-height: 1.25; white-space: pre-line;">' + TextEllipsis_55_2 + '</div>';
						}
						codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1;"><a href="' + f.columChannelLink + '" target="_blank" rel="noopener noreferrer" style="margin-right: 10px; color: #313160; font-weight: 500; text-decoration: none;">' + f.columChannel + '</a><span style="font-weight: 300;">作者 ' + f.columAuthor + '</span></div></td><td class="stack-column" width="20"></td><td class="stack-column" style="width: 6.125rem;"><table cellspacing="0" cellpadding="0" border="0" align="center"><tr><td><a href="' + f.columLink + '" style="display: block; padding: 0 1em; margin: 10px 0; color: #ffffff;font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif; font-size: 0.875rem; text-decoration: none; background: #313160; border: 0.5em solid #313160; border-radius: 5px;" class="button-a"><!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]-->' + f.columButton + '<!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]--></a></td></tr></table></td></tr></table></td></tr>';
						if ( f.columNote == "" ) {
							codeBody += '<tr><td style="padding: 0 6.667%;"><table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#dadada" width="100%" height="1"><tr><td></td></tr></table></td></tr>';
						}
					...
					case 'Ract-Img-Text':
						...
						if ( f.columText !== "" ) {
							...
							codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; font-weight: 300; line-height: 1.25; white-space: pre-line;">' + TextEllipsis_55_3 + '</div>';
						}
						codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1;"><a href="' + f.columChannelLink + '" target="_blank" rel="noopener noreferrer" style="margin-right: 10px; color: #313160; font-weight: 500; text-decoration: none;">' + f.columChannel + '</a><span style="font-weight: 300;">作者 ' + f.columAuthor + '</span></div><table cellspacing="0" cellpadding="0" border="0" width="100%"><tr><td class="stack-column-center" style="text-align: right;"><a href="' + f.columLink + '" style="display: inline-block; padding: 0 1em;margin: 15px 0 0;color: #ffffff;font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif;font-size: 0.875rem;text-decoration: none;background: #313160;border: 0.5em solid #313160;border-radius: 5px;" class="button-a"><!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]-->' + f.columButton + '<!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]--></a></td></tr></table></td></tr></table></td></tr></table></td></tr>';
						if ( f.columNote == "" ) {
							codeBody += '<tr><td style="padding: 0 6.667%;"><table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#dadada" width="100%" height="1"><tr><td></td></tr></table></td></tr>';
						}
					...
					case 'Circle-Img-Left':
						...
						if ( f.columText !== "" ) {
							...
							codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; font-weight: 300; line-height: 1.25; white-space: pre-line;">' + TextEllipsis_55_4 + '</div>';
						}
						codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1;"><a href="' + f.columChannelLink + '" target="_blank" rel="noopener noreferrer" style="margin-right: 10px; color: #313160; font-weight: 500; text-decoration: none;">' + f.columChannel + '</a><span style="font-weight: 300;">作者 ' + f.columAuthor + '</span></div><table cellspacing="0" cellpadding="0" border="0" width="100%"><tr><td class="stack-column-center" style="text-align: right;"><a href="' + f.columLink + '" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 0 1em;margin: 15px 0 0;color: #ffffff;font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif;font-size: 0.875rem;text-decoration: none;background: #313160;border: 0.5em solid #313160;border-radius: 5px;" class="button-a"><!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]-->' + f.columButton + '<!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]--></a></td></tr></table></td></tr></table></td></tr></table></td></tr>';
						if ( f.columNote == "" ) {
							codeBody += '<tr><td style="padding: 0 6.667%;"><table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#dadada" width="100%" height="1"><tr><td></td></tr></table></td></tr>';
						}
					...
					case 'Circle-Img-Right':
						...
						if ( f.columText !== "" ) {
							...
							codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; font-weight: 300; line-height: 1.25; white-space: pre-line;">' + TextEllipsis_55_5 + '</div>';
						}
						codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1;"><a href="' + f.columChannelLink + '" target="_blank" rel="noopener noreferrer" style="margin-right: 10px; color: #313160; font-weight: 500; text-decoration: none;">' + f.columChannel + '</a><span style="font-weight: 300;">作者 ' + f.columAuthor + '</span></div><table cellspacing="0" cellpadding="0" border="0" width="100%"><tr><td class="stack-column-center"><a href="' + f.columLink + '" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 0 1em;margin: 15px 0 0;color: #ffffff;font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif;font-size: 0.875rem;text-decoration: none;background: #313160;border: 0.5em solid #313160;border-radius: 5px;" class="button-a"><!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]-->' + f.columButton + '<!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]--></a></td></tr></table></td></tr></table></td></tr></table></td></tr>';
						if ( f.columNote == "" ) {
							codeBody += '<tr><td style="padding: 0 6.667%;"><table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#dadada" width="100%" height="1"><tr><td></td></tr></table></td></tr>';
						}
						break;
					case 'Rank':
						...
						codeBody += '</td></tr><tr><td style="padding: 0 6.6667%;"><table cellspacing="0" cellpadding="0" border="0" align="center"><tr><td><a href="#!" target="_blank" rel="noopener noreferrer" style="display: block;"><img src="' + ResizeImg_350by250 + '" width="350" alt="alt_text" border="0" style="display: block; width: 100%; max-width: 350px; height: auto;"></a></td></tr><tr><td style="padding: 5px 0 20px; color: #777; font-size: 0.875rem; font-weight: 300;">' + f.columAuthor + '</td></tr></table></td></tr>';
						if ( f.columText !== "" ) {
							codeBody += '<tr><td style="padding: 0 6.6667%; color: #000; font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif; font-size: 1rem; font-weight: 300; mso-height-rule: exactly; line-height: 1.5; white-space: pre-line;">' + f.columText + '</td></tr>';
						}
						if ( f.columButton !== "" ) {
		...
		previewFoot = '<table align="center" width="600" class="email-container"><tr><td dir="ltr" style="padding: 40px 3.333%; width: 100%;"><table cellspacing="0" cellpadding="0" border="0" align="center" width="100%"><tr><td class="stack-column-center" style="width: 8em; font-size: 0.875rem; text-align: center;"><a href="https://www.facebook.com/opinion.cw" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 0.5em 1em; color: #1877F2; font-size: 0.875rem; line-height: 1; background-color: #fff; border-radius: 5px;"><img src="https://topic.cw.com.tw/salesforce/assets/images/facebook.png" alt="Facebook Logo" width="20" style="display: inline-block; vertical-align: middle; margin-right: 0.5em;"><span style="display: inline-block; vertical-align: middle; line-height: 1.25rem;">追蹤獨評</span></a></td><td class="stack-column-center" style="width: 20px; height: 10px;"></td><td class="stack-column-center" style="text-align: left;"><a href="http://opinion.cw.com.tw/" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 0 10px 0 0; color: #000; font-size: 0.875rem; font-weight: 300; font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif; line-height: 1; mso-height-rule: exactly; text-decoration: none; border-right: 1px solid #000;">關於獨立評論@天下</a><a href="https://opinion.cw.com.tw/blog/profile/31/article/28" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 0 10px; color: #000; font-size: 0.875rem; font-weight: 300; font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif; line-height: 1; mso-height-rule: exactly; text-decoration: none; border-right: 1px solid #000;">讀者投書</a><a href="tel:+886226620332" style="display: inline-block; padding: 0 10px; color: #000; font-size: 0.875rem; font-weight: 300; font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif; line-height: 1; mso-height-rule: exactly; text-decoration: none;">讀者服務專線 (02) 2662-0332</a><div style="display: inline-block; color: #000; font-size: 0.875rem; font-weight: 300; font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif; mso-height-rule: exactly;">Copyright © 2021 天下雜誌 All rights reserved.</div></td></tr></table></td></tr></table>';
