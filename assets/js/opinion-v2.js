...
function makeSourceCode(key, worksheet) {
	...
	$.getJSON(gspreadsheets, function(result){
				...
				switch (f.columType) {
					...
					case 'Single-Article':
						...
						if ( f.columText !== "" ) {
							...
							codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1.25;">' + TextEllipsis_55_1 + '</div>';
						}
						codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1;"><a href="' + f.columChannelLink + '" target="_blank" rel="noopener noreferrer" style="margin-right: 10px; color: #313160; font-weight: 500; text-decoration: none;">' + f.columChannel + '</a><span>作者 ' + f.columAuthor + '</span></div></td><td class="stack-column" width="20"></td><td class="stack-column" style="width: 6.125rem;"><table cellspacing="0" cellpadding="0" border="0" align="center"><tr><td><a href="' + f.columLink + '" style="display: block; padding: 0 1em; margin: 10px 0; color: #ffffff;font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif; font-size: 0.875rem; text-decoration: none; background: #313160; border: 0.5em solid #313160; border-radius: 5px;" class="button-a"><!--[if mso]>&nbsp; &nbsp; &nbsp; &nbsp;<![endif]-->' + f.columButton + '<!--[if mso]>&nbsp; &nbsp; &nbsp; &nbsp;<![endif]--></a></td></tr></table></td></tr></table></td></tr>';
						if ( f.columNote == "" ) {
					...
					case 'Text-Button':
						...
						if ( f.columText !== "" ) {
							...
							codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1.25;">' + TextEllipsis_55_2 + '</div>';
						}
						codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1;"><a href="' + f.columChannelLink + '" target="_blank" rel="noopener noreferrer" style="margin-right: 10px; color: #313160; font-weight: 500; text-decoration: none;">' + f.columChannel + '</a><span>作者 ' + f.columAuthor + '</span></div></td><td class="stack-column" width="20"></td><td class="stack-column" style="width: 6.125rem;"><table cellspacing="0" cellpadding="0" border="0" align="center"><tr><td><a href="' + f.columLink + '" style="display: block; padding: 0 1em; margin: 10px 0; color: #ffffff;font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif; font-size: 0.875rem; text-decoration: none; background: #313160; border: 0.5em solid #313160; border-radius: 5px;" class="button-a"><!--[if mso]>&nbsp; &nbsp; &nbsp; &nbsp;<![endif]-->' + f.columButton + '<!--[if mso]>&nbsp; &nbsp; &nbsp; &nbsp;<![endif]--></a></td></tr></table></td></tr></table></td></tr>';
						if ( f.columNote == "" ) {
							codeBody += '<tr><td style="padding: 0 6.667%;"><table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#dadada" width="100%" height="1"><tr><td></td></tr></table></td></tr>';
					...
					case 'Ract-Img-Text':
						...
						if ( f.columText !== "" ) {
							...
							codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1.25;">' + TextEllipsis_55_3 + '</div>';
						}
						codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1;"><a href="' + f.columChannelLink + '" target="_blank" rel="noopener noreferrer" style="margin-right: 10px; color: #313160; font-weight: 500; text-decoration: none;">' + f.columChannel + '</a><span>作者 ' + f.columAuthor + '</span></div><table cellspacing="0" cellpadding="0" border="0" width="100%"><tr><td class="stack-column-center" style="text-align: right;"><a href="' + f.columLink + '" style="display: inline-block; padding: 0 1em;margin: 15px 0 0;color: #ffffff;font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif;font-size: 0.875rem;text-decoration: none;background: #313160;border: 0.5em solid #313160;border-radius: 5px;" class="button-a"><!--[if mso]>&nbsp; &nbsp; &nbsp; &nbsp;<![endif]-->' + f.columButton + '<!--[if mso]>&nbsp; &nbsp; &nbsp; &nbsp;<![endif]--></a></td></tr></table></td></tr></table></td></tr></table></td></tr>';
						if ( f.columNote == "" ) {
							codeBody += '<tr><td style="padding: 0 6.667%;"><table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#dadada" width="100%" height="1"><tr><td></td></tr></table></td></tr>';
						}
					...
					case 'Circle-Img-Left':
						...
						if ( f.columText !== "" ) {
							...
							codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1.25;">' + TextEllipsis_55_4 + '</div>';
						}
						codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1;"><a href="' + f.columChannelLink + '" target="_blank" rel="noopener noreferrer" style="margin-right: 10px; color: #313160; font-weight: 500; text-decoration: none;">' + f.columChannel + '</a><span>作者 ' + f.columAuthor + '</span></div><table cellspacing="0" cellpadding="0" border="0" width="100%"><tr><td class="stack-column-center" style="text-align: right;"><a href="' + f.columLink + '" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 0 1em;margin: 15px 0 0;color: #ffffff;font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif;font-size: 0.875rem;text-decoration: none;background: #313160;border: 0.5em solid #313160;border-radius: 5px;" class="button-a"><!--[if mso]>&nbsp; &nbsp; &nbsp; &nbsp;<![endif]-->' + f.columButton + '<!--[if mso]>&nbsp; &nbsp; &nbsp; &nbsp;<![endif]--></a></td></tr></table></td></tr></table></td></tr></table></td></tr>';
						if ( f.columNote == "" ) {
							codeBody += '<tr><td style="padding: 0 6.667%;"><table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#dadada" width="100%" height="1"><tr><td></td></tr></table></td></tr>';
						}
					...
					case 'Circle-Img-Right':
						...
						if ( f.columText !== "" ) {
							...
							codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1.25;">' + TextEllipsis_55_5 + '</div>';
						}
						codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1;"><a href="' + f.columChannelLink + '" target="_blank" rel="noopener noreferrer" style="margin-right: 10px; color: #313160; font-weight: 500; text-decoration: none;">' + f.columChannel + '</a><span>作者 ' + f.columAuthor + '</span></div><table cellspacing="0" cellpadding="0" border="0" width="100%"><tr><td class="stack-column-center"><a href="' + f.columLink + '" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 0 1em;margin: 15px 0 0;color: #ffffff;font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif;font-size: 0.875rem;text-decoration: none;background: #313160;border: 0.5em solid #313160;border-radius: 5px;" class="button-a"><!--[if mso]>&nbsp; &nbsp; &nbsp; &nbsp;<![endif]-->' + f.columButton + '<!--[if mso]>&nbsp; &nbsp; &nbsp; &nbsp;<![endif]--></a></td></tr></table></td></tr></table></td></tr></table></td></tr>';
						if ( f.columNote == "" ) {
							codeBody += '<tr><td style="padding: 0 6.667%;"><table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#dadada" width="100%" height="1"><tr><td></td></tr></table></td></tr>';
						}
						break;
					case 'Rank':
						...
						codeBody += '<tr><td><div style="padding-top: 20px;"></div></td></tr><tr><td><table cellspacing="0" cellpadding="0" border="0" align="center" width="240"><tr><td valign="bottom" style="width: 27.5%; color: #313160; font-family: \'Times New Roman\', Times, serif; font-style: italic; font-size: 7.5rem; line-height: 1; white-space: nowrap;">' + f.columChannel + '</td><td valign="bottom" style="width: 72.5%; padding: 0 0 1.25rem; color: #313160;"><div style="font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif; font-size: 1rem;">' + f.columChannelLink + '</div><div style="padding: 3px 0 0; font-family: \'Noto Serif TC\', \'思源宋體 TC\', \'思源宋體 TW\', \'思源宋體\', serif; font-weight: bold; font-size: 1.5rem; line-height: 1.125;">' + f.columTitle + '</div></td></tr></table></td></tr><tr><td style="padding: 0 6.6667%;"><table cellspacing="0" cellpadding="0" border="0" align="center"><tr><td><a href="#!" target="_blank" rel="noopener noreferrer" style="display: block;"><img src="' + ResizeImg_350by250 + '" width="350" alt="alt_text" border="0" style="display: block; width: 100%; max-width: 350px; height: auto;"></a></td></tr><tr><td style="padding: 5px 0 20px; color: #777; font-size: 0.875rem;">' + f.columAuthor + '</td></tr></table></td></tr>';
						if ( f.columText !== "" ) {
							codeBody += '<tr><td style="padding: 0 6.6667%; color: #000; font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif; font-size: 1rem; mso-height-rule: exactly; line-height: 1.5;">' + f.columText + '</td></tr>';
						}
						if ( f.columButton !== "" ) {
		...
		previewFoot = '<table align="center" width="600" class="email-container"><tr><td dir="ltr" style="padding: 40px 3.333%; width: 100%;"><table cellspacing="0" cellpadding="0" border="0" align="center" width="100%"><tr><td class="stack-column-center" style="width: 8em; font-size: 0.875rem; text-align: center;"><a href="https://www.facebook.com/opinion.cw" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 0.5em 1em; color: #1877F2; font-size: 0.875rem; line-height: 1; background-color: #fff; border-radius: 5px;"><img src="https://topic.cw.com.tw/salesforce/assets/images/facebook.png" alt="Facebook Logo" width="20" style="display: inline-block; vertical-align: middle; margin-right: 0.5em;"><span style="display: inline-block; vertical-align: middle; line-height: 1.25rem;">追蹤獨評</span></a></td><td class="stack-column-center" style="width: 20px; height: 10px;"></td><td class="stack-column-center" style="text-align: left;"><a href="http://opinion.cw.com.tw/" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 0 10px 0 0; font-size: 0.875rem; color: #000; font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif; line-height: 1; mso-height-rule: exactly; text-decoration: none; border-right: 1px solid #000;">關於獨立評論@天下</a><a href="https://opinion.cw.com.tw/blog/profile/31/article/28" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 0 10px; font-size: 0.875rem; color: #000; font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif; line-height: 1; mso-height-rule: exactly; text-decoration: none; border-right: 1px solid #000;">讀者投書</a><a href="tel:+886226620332" style="display: inline-block; padding: 0 10px; font-size: 0.875rem; color: #000; font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif; line-height: 1; mso-height-rule: exactly; text-decoration: none;">讀者服務專線 (02) 2662-0332</a><div style="display: inline-block; font-size: 0.875rem; color: #000; font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif; mso-height-rule: exactly;">Copyright © 2021 天下雜誌 All rights reserved.</div></td></tr></table></td></tr></table>';
