				...
				switch (f.columType) {
					...
					case 'Single-Article':
						...
						if ( f.columText !== "" ) {
							...
							codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1.25; white-space: pre-line;">' + TextEllipsis_55_1 + '</div>';
						}
						codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1;"><a href="' + f.columChannelLink + '" target="_blank" rel="noopener noreferrer" style="margin-right: 10px; color: #313160; font-weight: 500; text-decoration: none;">' + f.columChannel + '</a><span>作者 ' + f.columAuthor + '</span></div>';
						if ( f.columButton !== "" ) {
					...
					case 'Text-Button':
						...
						if ( f.columText !== "" ) {
							...
							codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1.25; white-space: pre-line;">' + TextEllipsis_55_2 + '</div>';
						}
					...
					case 'Ract-Img-Text':
						...
						if ( f.columText !== "" ) {
							...
							codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1.25; white-space: pre-line;">' + TextEllipsis_55_3 + '</div>';
						}
					...
					case 'Circle-Img-Left':
						...
						if ( f.columText !== "" ) {
							...
							codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1.25; white-space: pre-line;">' + TextEllipsis_55_4 + '</div>';
						}
					...
					case 'Circle-Img-Right':
						...
						if ( f.columText !== "" ) {
							...
							codeBody += '<div style="padding: 5px 0; color: #777; font-size: 0.875rem; line-height: 1.25; white-space: pre-line;">' + TextEllipsis_55_5 + '</div>';
						}
					...
					case 'Rank':
						...
						if ( f.columText !== "" ) {
							codeBody += '<tr><td style="padding: 0 6.6667%; color: #000; font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif; font-size: 1rem; mso-height-rule: exactly; line-height: 1.5; white-space: pre-line;">' + f.columText + '</td></tr>';
						}
						if ( f.columButton !== "" ) {
