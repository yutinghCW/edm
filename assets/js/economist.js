var width = $(window).width(),
    initial = "https://yutinghcw.github.io/edm/initial/economist.html",
...
function makeSourceCode(key, worksheet) {
    ...
    $.getJSON(gspreadsheets, function(l) {
        ...
        previewHead = '<table bgcolor="#fff" cellpadding="0" cellspacing="0" border="0" height="100%" width="100%" style="border-collapse:collapse;"><tr><td><center style="width: 100%;"><div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; font-family: sans-serif;">' + data.funcColum[0].columChannel + '</div><table cellspacing="0" cellpadding="0" border="0" align="center" width="700" class="email-container"><tr><td style="padding: 10px;"><table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" class="email-container"><tr><td><a style="display: block; line-height: 0;" href="https://www.cw.com.tw/" target="_blank" rel="noopener noreferrer"><img src="https://topic.cw.com.tw/edmtest/img/title-eco.jpg" width="100%" alt="天下雜誌"></a></td></tr></table></td></tr><tr><td style="padding: 0 10px;"><table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" class="email-container"><tr><td style="padding: 20px 0; text-align: center;"><p style="margin: 0; color: #666; font-size: 1rem;">本週主題</p><h1 style="margin: 0.25rem 0 0.5rem; color: #000; font-size: 2.25rem; font-weight: 500; line-height: 1.25;">' + data.funcColum[0].columTitle + '</h1><a class="unsubscribe" href="' + initial + "?file=" + key + '" target="_blank" rel="noopener noreferrer" style="color: #666; font-size: 0.8125rem; text-decoration: none;">無法看到完整內容，請點此處</a></td></tr><tr><td style="padding: 20px 0; text-align: center; font-size: 0.875rem; border-bottom: 1px solid #000;"><p style="margin-top: 0; margin-bottom: 0.5rem; color: #003A9F; font-weight: 500;">《本期議題快速看》</p>' + data.funcColum[0].columText + '</td></tr></table></td></tr></table><table cellspacing="0" cellpadding="0" border="0" align="center" width="700" class="email-container">';
