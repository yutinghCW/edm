$(function () {
	var width = $(window).width(),
		initial = "https://topic.cw.com.tw/edm/cw_40/cw40.html",
    ...
    var edmUrl = "https://topic.cw.com.tw/edm/salesforce/initial/cwedm.html";
    ...
    function makeSourceCode(key, worksheet) {
        ...
        $.getJSON(gspreadsheets, function(l) {
            ...
            $("#previewHtml").html(previewHead+codeBody+codeFoot);
