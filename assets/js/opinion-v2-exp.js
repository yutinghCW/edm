var width = $(window).width(),
	initial = "https://yutinghcw.github.io/edm/initial/opinion-v2-exp.html",
...
function makeSourceCode(key, worksheet) {
	...
	$.getJSON(gspreadsheets, function(result){
		...
		// 組裝原始碼第一段，版頭及表頭
		previewHead = '<div style="display:none; font-size:1px; line-height:1px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; mso-hide:all; font-family: \'Roboto\', \'Noto Sans TC\', \'思源黑體 TC\', \'思源黑體 TW\', \'思源黑體\', \'微軟正黑體\', \'繁黑體\', \'Microsoft JhengHei\', \'Lato\', \'Arial\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'新細明體\', sans-serif;">我是一個大家看不到的前言</div><table cellspacing="0" cellpadding="0" border="0" align="center" width="600" class="email-container"><tr><td width="90"><a href="http://opinion.cw.com.tw/" style="display: block;" target="_blank" rel="noopener noreferrer"><img src="https://topic.cw.com.tw/salesforce/assets/images/opinion-logo-red@3x.png" height="30" alt="獨立評論@天下 Logo" border="0" style="display: block;"></a></td><td style="padding: 0 0 10px; text-align: right;"><a class="unsubscribe" href="' + initial + "?file=" + key + '" target="_blank" rel="noopener noreferrer" style="display: block; color: #777; font-size: 0.75rem; text-decoration: none;">無法看到完整內容，請點此處</a></td></tr></table><div style="padding: 15px 0 0;"></div><table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" width="600" class="email-container"><tr><td style="padding-top: 40px; text-align: center;"><h2 style="margin: 0 0 5px; padding: 0 6.6675%; color: #313160; font-family: \'Noto Serif TC\', \'思源宋體 TC\', \'思源宋體 TW\', \'思源宋體\', serif; font-size: 1.5rem;">' + data.funcColum[0].columTitle + '</h2><time style="margin-bottom: 10px; padding: 0 6.6675%; color: #777; font-size: 0.875rem;">' + data.funcColum[0].columLink + '</time><div style="margin: 10px 0 20px; padding: 0 6.6675%; color: #000; font-size: 1rem; font-weight: 400; line-height: 1.7; text-align: left; white-space: pre-line;">' + data.funcColum[0].columText + '</div>';
