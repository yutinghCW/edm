...
function makeSourceCode(key, worksheet) {
    ...
    $.getJSON(gspreadsheets, function(l) {
        ...
        } else if ( window.location.href.indexOf('generator') > 0 ) {
            prefix = '&email=';
            email = '%%email%%';
        } else {
            prefix = '';
