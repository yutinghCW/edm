var width = $(window).width(),
    ...
    initial = host + "/initial/cweng.html",
    playlist = host + "/initial/playlist-en.html",
...
function makeSourceCode(key, worksheet) {
    ...
    $.getJSON(gspreadsheets, function(l) {
        ...
        previewHead = '<table bgcolor="#fff" cellpadding="0" cellspacing="0" border="0" height="100%" width="100%" style="border-collapse:collapse;"><tr><td><center style="width: 100%;"><div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;">' + data.funcColum[0].columTitle + ': ' + data.funcColum[0].columText + '</div><table align="center" width="700" class="email-container"><tr bgcolor="#d60c18"><td style="padding: 0; text-align: center;"><a style="display: block; line-height: 0;" href="https://english.cw.com.tw/" target="_blank" rel="noopener noreferrer"><img src="https://topic.cw.com.tw/edm/cwEnglish/images/logo.jpg" style="display: inline-block; width: 140px;" alt="CommonWealth Magazine"></a></td></tr><tr><td style="padding: 1rem 0; text-align: center; border-bottom: 1px solid #c9c9c9;"><p style="margin: 0 0 5px; color:#333; font-family: Georgia, \'Libre Baskerville\', serif; font-size: 1rem; line-height: 1.5;"><span style="color: #999; font-size: 1rem;">' + data.funcColum[0].columChannel + '</span><br/>' + data.funcColum[0].columTitle + '</p><p style="margin: 0; font-family: Georgia, \'Libre Baskerville\', serif;"><span style="color:#999; font-size: 0.8125rem;">Not Coming Through? Click <a id="edmLink" class="unsubscribe" style="color:#D60C18; text-decoration: underline;" href="' + initial + "?file=" + key + '&email=%%email%%">here</a></span></p></td></tr><tr><td style="padding: 1rem 2.858%; border-bottom: 1px solid #c9c9c9;"><a href="' + data.funcColum[1].columLink + '" style="display: block; color: #666; font-family: Georgia, \'Libre Baskerville\', serif; font-size: 0.8125rem; line-height: 1.5; text-decoration: none;" target="_blank">' + data.funcColum[1].columTitle + '</a></td></tr></table><table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#fff" width="700" class="email-container">';
