...
function makeSourceCodeExp(key, worksheet) {
    ...
    $.getJSON(gspreadsheets, function(l) {
        ...
        if( data1.funcColum[0].columImage !== "" !== "" ){
        ...
        if ( window.location.href.indexOf('playID=all') > 0 ) {
            codeFrame = '<tr><td style="padding-top: 20px;"><iframe id="player" width="100%" height="250" scrolling="no" frameborder="no" src="' + playlistExp + "?file=" + key + '&Daily=' + data1.funcColum[0].columImage +'&playID=all' + '" style="display: none;"></iframe></td></tr>';
        }
        ...
        $(function() {
            $.each(data1.funcColum, function(i, f) {
                if (i == 0) {
                    ...
                    switch (f.columType) {
                        ...
                        case 'Single-Image':
                            multiColumCont++;
                            sectionOne += '<table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="min-width: 100%; " class="stylingblock-content-wrapper"><tr><td class="stylingblock-content-wrapper camarker-inner"><table cellspacing="0" cellpadding="0" border="0" width="700" class="container" align="center"><tr><td class="slot-styling camarker-inner"><table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="min-width: 100%; font-family: roboto, noto sans tc, 思源黑體 tc, 思源黑體 tw, 思源黑體, 微軟正黑體, 繁黑體, microsoft jhenghei, arial, sans-serif; font-size: 1.125rem; line-height: 1.875rem;" class="stylingblock-content-wrapper"><tr><td class="stylingblock-content-wrapper camarker-inner"><table width="100%" cellspacing="0" cellpadding="0" role="presentation"><tr><td align="center" style="padding: 1rem 2.858%; border-bottom: 1px solid #c9c9c9;"><a href="' + f.columLink + '" target="_blank"><img src="' + f.columImage + '" height="100" width="auto" border="0" class="full-width" style="display: block;margin:0; max-width:100%;" alt="' + f.columTitle + '"></a></td></tr></table></td></tr></table></td></tr></table></td></tr></table>';
                            break;
                        case 'Section-Title':
                            multiColumCont++;
                            sectionOne += '<table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="min-width: 100%; " class="stylingblock-content-wrapper"><tr><td class="stylingblock-content-wrapper camarker-inner"><table cellspacing="0" cellpadding="0" border="0" width="700" class="container" align="center"><tr><td class="slot-styling camarker-inner"><table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="min-width: 100%; font-family: roboto, noto sans tc, 思源黑體 tc, 思源黑體 tw, 思源黑體, 微軟正黑體, 繁黑體, microsoft jhenghei, arial, sans-serif; font-size: 1.125rem; line-height: 1.875rem; border-bottom: 2px solid #000;" class="stylingblock-content-wrapper"><tr><td class="stylingblock-content-wrapper camarker-inner"><table width="100%" cellspacing="0" cellpadding="0" role="presentation"><tr><td style="padding: 20px 10px 5px;"><b>' + f.columTitle + '&nbsp;&nbsp;<span style="color: #d60c18;">' + f.columText + '</span></b></td></tr></table></td></tr></table></td></tr></table></td></tr></table>';
                            break;
                        case 'Double-Column':
                            multiColumCont++;
                            if ( multiColumCont == 4 ) {
                    ...
                    switch (f.columType) {
                        ...
                        case 'Single-Image':
                            multiColumCont++;
                            sectionTwo += '<table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="min-width: 100%; " class="stylingblock-content-wrapper"><tr><td class="stylingblock-content-wrapper camarker-inner"><table cellspacing="0" cellpadding="0" border="0" width="700" class="container" align="center"><tr><td class="slot-styling camarker-inner"><table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="min-width: 100%; font-family: roboto, noto sans tc, 思源黑體 tc, 思源黑體 tw, 思源黑體, 微軟正黑體, 繁黑體, microsoft jhenghei, arial, sans-serif; font-size: 1.125rem; line-height: 1.875rem;" class="stylingblock-content-wrapper"><tr><td class="stylingblock-content-wrapper camarker-inner"><table width="100%" cellspacing="0" cellpadding="0" role="presentation"><tr><td align="center" style="padding: 1rem 2.858%; border-bottom: 1px solid #c9c9c9;"><a href="' + f.columLink + '" target="_blank"><img src="' + f.columImage + '" height="100" width="auto" border="0" class="full-width" style="display: block;margin:0; max-width:100%;" alt="' + f.columTitle + '"></a></td></tr></table></td></tr></table></td></tr></table></td></tr></table>';
                            break;
                        case 'Section-Title':
                            multiColumCont++;
                            sectionTwo += '<table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="min-width: 100%; " class="stylingblock-content-wrapper"><tr><td class="stylingblock-content-wrapper camarker-inner"><table cellspacing="0" cellpadding="0" border="0" width="700" class="container" align="center"><tr><td class="slot-styling camarker-inner"><table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="min-width: 100%; font-family: roboto, noto sans tc, 思源黑體 tc, 思源黑體 tw, 思源黑體, 微軟正黑體, 繁黑體, microsoft jhenghei, arial, sans-serif; font-size: 1.125rem; line-height: 1.875rem; border-bottom: 2px solid #000;" class="stylingblock-content-wrapper"><tr><td class="stylingblock-content-wrapper camarker-inner"><table width="100%" cellspacing="0" cellpadding="0" role="presentation"><tr><td style="padding: 20px 10px 5px;"><b>' + f.columTitle + '&nbsp;&nbsp;<span style="color: #d60c18;">' + f.columText + '</span></b></td></tr></table></td></tr></table></td></tr></table></td></tr></table>';
                        ...
                        case 'Double-Column':
                            ...
                            sectionTwo += '<table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="min-width: 100%; " class="stylingblock-content-wrapper"><tr><td class="stylingblock-content-wrapper camarker-inner"><table cellspacing="0" cellpadding="0" border="0" width="700" class="container" align="center"><tr><td><table style="background-color : #FFFFFF; border : 0px solid transparent;font-size : 16px; font-family : Arial, helvetica, sans-serif; line-height : 150%; color : #171717; " class="tb_properties border_style" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" width="100%"><tr><td align="center" valign="top"><table align="left" border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td class="content_padding" style="border:0px;padding : 0px; "><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td align="left" class="" valign="top"><table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="min-width: 100%; " class="slot-styling"><tr><td style="padding: 20px 0 10px; ' + line + '" class="slot-styling camarker-inner"><table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="text-align: left; min-width: 100%; " class="stylingblock-content-wrapper"><tr><td style="padding: 0 10px;"><span style="display: block; color: #D60C18; font-family: roboto, noto sans tc, 思源黑體 tc, 思源黑體 tw, 思源黑體, 微軟正黑體, 繁黑體, microsoft jhenghei, arial, sans-serif; font-size: 1rem; font-weight: bold;">» ' + f.columChannel + '</span></td></tr><tr><td style="padding: 0;" class="stylingblock-content-wrapper camarker-inner" align="left"><table cellspacing="0" cellpadding="0" style="width: 100%;"><tr><td><table cellspacing="0" cellpadding="0" style="width: 100%;"><tr><td class="responsive-td" valign="middle" style="width: 44%; padding-left: 10px; padding-right: 10px;"><table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="min-width: 100%; " class="stylingblock-content-wrapper"><tr><td style="padding-top: 10px; padding-bottom: 10px;" class="stylingblock-content-wrapper camarker-inner"><a href="' + f.columLink + '" target="_blank" rel="noopener noreferrer" style="display: block;"><img src="' + f.columImage + '" height="auto" width="100%" style="height:auto;width:100%;display: block;"></a></td></tr></table></td><td class="responsive-td" valign="middle" style="width: 56%; padding-left: 10px; padding-right: 10px;"><table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="text-align: left; min-width: 100%; " class="stylingblock-content-wrapper"><tr><td class="stylingblock-content-wrapper camarker-inner" align="left"><a href="' + f.columLink + '" rel="noopener noreferrer" style="display: block; padding: 10px 0; text-align: left; text-decoration: none; color: #1f4f82; font-family: roboto, noto sans tc, 思源黑體 tc, 思源黑體 tw, 思源黑體, 微軟正黑體, 繁黑體, microsoft jhenghei, arial, sans-serif; font-size: 1.25rem; font-weight: bold; line-height: 1.5;" target="_blank">' + f.columTitle + '</a><p style="margin: 0; padding: 0 0 10px; color: #333; font-family: roboto, noto sans tc, 思源黑體 tc, 思源黑體 tw, 思源黑體, 微軟正黑體, 繁黑體, microsoft jhenghei, arial, sans-serif; font-size: 0.875rem; text-align: left; line-height: 1.5;">' + f.columText + '<a href="' + f.columLink + '" style="color: #1f4f82; text-decoration: none;" target="_blank">...more</a></p></td></tr></table></td></tr></table></td></tr></table></td></tr></table></td></tr></table></td></tr></table></td></tr></table></td></tr></table></td></tr></table></td></tr></table>';
                            break;
                        case 'foot':
                            console.log('foot');
                            break;
            ...
            sectionTwo += '<table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="min-width: 100%; " class="stylingblock-content-wrapper"><tr><td class="stylingblock-content-wrapper camarker-inner"><tr><td width="100%" style="padding: 10px 1.43%;"></td></tr></td></tr></table>'
        });
